...
public class GuiTooltips extends GuiScreen {
	...
	public void drawTooltip(ScaledResolution sr) {
		...
		drawString(mc.fontRendererObj, desc1, (sr.getScaledWidth() / 2) - 83, (sr.getScaledHeight() / 2) + 49, 0xFFFFFF);
		drawString(mc.fontRendererObj, desc2, (sr.getScaledWidth() / 2) - 83, (sr.getScaledHeight() / 2) + 60, 0xFFFFFF);
		drawString(mc.fontRendererObj, desc3, (sr.getScaledWidth() / 2) - 83, (sr.getScaledHeight() / 2) + 71, 0xFFFFFF);
		drawString(mc.fontRendererObj, desc4, (sr.getScaledWidth() / 2) - 83, (sr.getScaledHeight() / 2) + 82, 0xFFFFFF);
	}
